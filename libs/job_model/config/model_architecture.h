...
[[nodiscard]] JOBMODEL_EXPORT constexpr std::string_view modelArchitectureToString(ModelArchitecture arch) noexcept
{
    ...
    case ModelArchitecture::Qwen2Moe:    return "qwen2moe";
    case ModelArchitecture::Phi2:        return "phi2";
    case ModelArchitecture::Phi3:        return "phi3";
    case ModelArchitecture::StarCoder2:  return "starcoder2";
...
{
    if (str == "llama" || str == "mistral" || str == "mixtral") return ModelArchitecture::Llama;
    if (str == "gemma")                                          return ModelArchitecture::Gemma;
    if (str == "gemma2")                                         return ModelArchitecture::Gemma2;
    if (str == "qwen")                                           return ModelArchitecture::Qwen;
    if (str == "qwen2")                                          return ModelArchitecture::Qwen2;
    if (str == "qwen2moe")                                       return ModelArchitecture::Qwen2Moe;
    if (str == "qwen3")                                          return ModelArchitecture::Qwen3;
    if (str == "phi2" || str == "phi-2")                         return ModelArchitecture::Phi2;
    if (str == "phi3" || str == "phi-3")                         return ModelArchitecture::Phi3;
    if (str == "starcoder2")                                     return ModelArchitecture::StarCoder2;
    if (str == "falcon")                                         return ModelArchitecture::Falcon;
    if (str == "deepseek" || str == "deepseek2")                 return ModelArchitecture::DeepSeek;
    if (str == "bert" || str == "nomic-bert")                    return ModelArchitecture::Bert;
    if (str == "command-r" || str == "cohere")                  return ModelArchitecture::CommandR;
