...
static bool jsonToFieldValue_DumbRecursive(const json &j_val, FieldValue &out_fv)
{
    try {
        if (j_val.is_null()) {
            ...
            out_fv.value = FieldValue::Scalar{static_cast<uint32_t>(j_val.get<bool>())};
...
bool ISerializer::encode(const Schema &schema,
...
bool ISerializer::decode(const Schema &schema,
...
bool ISerializer::encodeJson(const Schema &schema,
                             const RuntimeObject &object,
...
bool ISerializer::decodeJson(const Schema &schema,
                             RuntimeObject &outObject,
...
bool ISerializer::encodeYaml(const Schema &schema,
                             const RuntimeObject &object,
                             std::vector<uint8_t> &outBuffer) noexcept
{
    bool ret = false;
...
bool ISerializer::decodeYaml(const Schema &schema,
                             RuntimeObject &outObject,
                             const std::vector<uint8_t> &inBuffer) noexcept
{
    bool ret = false;
...
bool ISerializer::encodeBinary([[maybe_unused]] const Schema &schema,
                               [[maybe_unused]] const RuntimeObject &object,
                               [[maybe_unused]] std::vector<uint8_t> &outBuffer) noexcept
{
    JOB_LOG_ERROR("[serializer] encodeBinary is not implemented in the base class");
    return false;
}

bool ISerializer::decodeBinary([[maybe_unused]] const Schema &schema,
                               [[maybe_unused]] RuntimeObject &outObject,
                               [[maybe_unused]] const std::vector<uint8_t> &inBuffer) noexcept
{
    JOB_LOG_ERROR("[serializer] decodeBinary is not implemented in the base class");
    return false;
}

bool ISerializer::encodeText([[maybe_unused]] const Schema &schema,
                             [[maybe_unused]] const RuntimeObject &object,
                             [[maybe_unused]] std::vector<uint8_t> &outBuffer) noexcept
{
...
bool ISerializer::decodeText([[maybe_unused]] const Schema &schema,
                             [[maybe_unused]] RuntimeObject &outObject,
                             [[maybe_unused]] const std::vector<uint8_t> &inBuffer) noexcept
{
