    ...
    ActivationType act = ActivationType::GELU)
{
    ...
    sgemm_parallel(pool, Batch, d_hidden, d_model,
    ...
    sgemm_parallel(pool, Batch, d_model, d_hidden, core::real_t(1.0), HiddenBuf,
...
{
    // X * W_gate -> GateBuf
    sgemm_parallel(pool, Batch, d_hidden, d_model, core::real_t(1.0), X,
    ...
    // GateBuf * W_proj -> Out
    sgemm_parallel(pool, Batch, d_model, d_hidden, core::real_t(1.0),
