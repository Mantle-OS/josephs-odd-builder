...
struct NEON_F {
    static constexpr int width() { return 4; } // 128-bit = 4 floats
    ...
    [[nodiscard]] static inline f32 bit_and(f32 a, f32 b)
    {
        return vreinterpretq_f32_u32(vandq_u32(vreinterpretq_u32_f32(a), vreinterpretq_u32_f32(b)));
    }

    [[nodiscard]] static inline f32 bit_or(f32 a, f32 b)
    {
        return vreinterpretq_f32_u32(vorrq_u32(vreinterpretq_u32_f32(a), vreinterpretq_u32_f32(b)));
    }

    [[nodiscard]] static inline f32 bit_xor(f32 a, f32 b)
    {
