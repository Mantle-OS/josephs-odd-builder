...
### [Computation](docs/job/ai/comp.md)
...
### [Inference](docs/job/ai/infer.md)
...
### [Training (Coach)](docs/job/ai/coach.md)
...
### [Specialized Learning Tasks](docs/job/ai/learn.md)
...
### [M.O.E (Mixture of Experts)](docs/job/ai/moe.md)


### [Routing](docs/job/ai/router.md)
...
### [Adapters](docs/job/ai/adapter.md)
