...
TEST_CASE("jsonToScalar converts FieldValue::Scalar to nlohmann::json", "[serializer_utils]")
{
    SECTION("int32_t")
    {
        FieldValue::Scalar scalar = static_cast<int32_t>(-123);
    ...
    SECTION("uint32_t")
    {
        FieldValue::Scalar scalar = static_cast<uint32_t>(456);
        nlohmann::json j = jsonToScalar(scalar);
    ...
    SECTION("int64_t")
    {
        FieldValue::Scalar scalar = static_cast<int64_t>(-7890123456);
        nlohmann::json j = jsonToScalar(scalar);
    ...
    SECTION("uint64_t")
    {
        FieldValue::Scalar scalar = static_cast<uint64_t>(9876543210);
        nlohmann::json j = jsonToScalar(scalar);
